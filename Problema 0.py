...
arrecadacao_meia = 0
arrecadacao_ecomp = 0
# Contador de cortesia, que vai acumular a comissão total
comissao_total = 0
        ...
        if pergunta1 == 1:
            ...
            if curso == 1:
                ...
                while total_aux != quantidade_vendida:
                    ...
                    if total_aux != quantidade_vendida:
                        print("Digite valores cuja soma seja equivalente às vendas feitas\n")
                ...
                quantidade_vendida = int(input("Digite a quantidade de ingressos vendidos\n"))
                while quantidade_vendida > total_de_ingressos:
                    quantidade_vendida = int(input("Digite uma quantidade igual ou menor de ingressosdisponíveis\n"))
                while total_aux != quantidade_vendida:
                    # Ceĺula referente ao cálculo da quantidade de ingressos e idades para INTEIRAS
